...
import com.seventimes.set.KdTree;
import com.seventimes.set.PointSet;
import com.seventimes.set.PointSetBrute;
...
public class RangeSearchVisualizer {
    ...
    public static void main(String[] args) {
        ...
        PointSet brute = new PointSetBrute();
        ...
        double x0 = 0.0, y0 = 0.5;      // initial endpoint of rectangle
        double x1 = 0.0, y1 = 0.5;      // current location of mouse
